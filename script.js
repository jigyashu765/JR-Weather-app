...
async function getWeather() {
    ...
    if (response.ok) {
      ...
      Column.innerHTML = `
          ...
          <div class="card mb-4 rounded-3 shadow-sm border-primary">
            ...
            <div class="card-body">
            <h1 class="card-title pricing-card-title" id='currentTemperature'>
              ${Temp}
              <small class="text-body-secondary fw-light"><span>&#x2103;</span> | <span onClick="celToFar()">&#x2109;</span></small>
            </h1>
  ...
  document.getElementById('cityInp').focus();
}
...
function celToFar() {
  document.getElementById('currentTemperature').innerHTML = `${TempInFar.toFixed(2)}<small class="text-body-secondary fw-light"><span>&#x2109;</span> | <span onClick="farToCel()">&#x2103;</span></small>`;
}

function farToCel() {
  document.getElementById('currentTemperature').innerHTML = `${Temp}<small class="text-body-secondary fw-light"><span>&#x2103;</span> | <span onClick="celToFar()">&#x2109;</span></small>`;
}
